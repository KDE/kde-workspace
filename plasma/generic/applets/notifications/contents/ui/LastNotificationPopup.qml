...
PlasmaCore.Dialog {
    ...
    mainItem: MouseEventListener {
        ...
        property int maximumWidth: theme.mSize(theme.defaultFont)(theme.defaultFont).width * 35
        property int maximumHeight: theme.mSize(theme.defaultFont)(theme.defaultFont).width * 10
                ...
                Column {
                    ...
                    Repeater {
                        ...
                        PlasmaComponents.Button {
                            text: model.text
                            width: theme.mSize(theme.defaultFont)(theme.defaultFont).width * 8
                            height: theme.mSize(theme.defaultFont)(theme.defaultFont).width * 2
                            onPressedChanged: {
                                if (pressed) {
