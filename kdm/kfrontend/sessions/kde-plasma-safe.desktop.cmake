...
Name[en_GB]=KDE Plasma Workspace (failsafe session)
Name[es]=Espacio de trabajo Plasma de KDE (sesión a prueba de fallos)
Name[et]=KDE Plasma töötsoon (turvaline seanss)
Name[eu]=KDEren Plasma laneko eremua (hutsegiteetatik babestutako saioa)
...
Name[pt_BR]=Espaço de Trabalho Plasma do KDE (sessão segura)
...
Name[sl]=Delovni prostor KDE Plasma (zasilna seja)
...
Comment[en_GB]=The desktop made by KDE (failsafe session)
Comment[es]=El escritorio diseñado por KDE (sesión a prueba de fallos)
Comment[et]=KDE loodud töölaud (turvaline seanss)
Comment[eu]=KDE-k egindako mahaigaina (hutsegiteetatik babestutako saioa)
Comment[fi]=KDE:n tekemä työpöytä (vikasietoinen istunto)
Comment[fr]=Le bureau développé par KDE (session de secours)
...
Comment[sl]=Namizje, ki ga je izdelal KDE (zasilna seja)
